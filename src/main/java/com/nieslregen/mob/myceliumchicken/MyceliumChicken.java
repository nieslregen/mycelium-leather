...
public class MyceliumChicken extends SetupAnimal implements NeutralMob {
    ...
    public void resetTrollCooldown() {
...
//        this.targetSelector.addGoal(1, new MyceliumChicken.ChaseEggThiefGoal(this));
        this.targetSelector.addGoal(2, new DefendNestGoal(this));
