...
public class HugeRedMushroomWithHollowFeature extends AbstractHugeMushroomWithHollow {
    public HugeRedMushroomWithHollowFeature(Codec<HugeMushroomFeatureConfiguration> codec) {
        super(codec);
    }
