...
public class HugeBrownMushroomWithHollowFeature extends AbstractHugeMushroomWithHollow {
    public HugeBrownMushroomWithHollowFeature(Codec<HugeMushroomFeatureConfiguration> codec) {
        super(codec);
    }
